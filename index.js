var x={attachFile:["M16.5 6v11.5a4 4 0 0 1-8 0V5a2.5 2.5 0 0 1 5 0v10.5a1 1 0 0 1-2 0V6H10v9.5","a2.5 2.5 0 0 0 5 0V5a4 4 0 0 0-8 0v12.5a5.5 5.5 0 0 0 11 0V6h-1.5Z"].join(""),stop:"M6 6h12v12H6V6Z",send:"M2 21 23 12 2 3v7l15 2-15 2v7Z",terminal:"M3 4h18v16H3V4Zm2 2v12h14V6H5Zm2 3 1.1-1.1L12.2 12l-4.1 4.1L7 15l3-3-3-3Zm6 6h5v1.5h-5V15Z",file:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6Zm0 2.5L17.5 8H14V4.5ZM8 13h8v1.5H8V13Zm0 3h8v1.5H8V16Z"},r={attachFile:k("attach_file",x.attachFile),stop:k("stop",x.stop),send:k("send",x.send),terminal:k("terminal",x.terminal)};function S1(b){return`<span class="composer-spinner" aria-hidden="true"></span><span class="sr-only">${S(b)}</span>`}function k(b,w){return`<svg class="material-icon" data-material-icon="${b}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="currentColor" d="${w}"></path></svg>`}function S(b){return b.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Z1(){return"pi-web-chat-mounted"}function d1(){let b=document.createElement("main");return b.className="main pi-web-chat-surface",b.dataset.main="session",b.dataset.pluginChatRoot="",b.innerHTML='<div class="term"><div class="term-inner" role="log" aria-live="polite" aria-relevant="additions text"></div></div><button type="button" class="scroll-bottom-btn" data-action="scroll-bottom" aria-label="stick to bottom" title="stick to bottom" aria-pressed="true" hidden>↓</button>',b}function n1(){let b=document.createElement("section");return b.className="prompt-region pi-web-chat-composer",b.innerHTML=`
  ...
  `}function s1(){document.getElementById("pi-web-chat-style")?.remove();let b=document.createElement("style");return b.id="pi-web-chat-style",b.textContent=t1(),document.head.append(b),b}function $1(b){return b.command||b.cmd||(b.name?`/${b.name}`:"")}function l(b){if(!b)throw Error("pi-web-chat DOM template is invalid");return b}function Hb(b,w,f){return{threadId:b,runId:w,state:{},messages:f,tools:[],context:[]}}function _b(b){let w=[...b.messages].reverse().find((f)=>f.role==="user");return{text:w?.text||"",attachments:w?.attachments||[],sessionId:b.threadId}}function Rb(b,w,f){return b.map((p)=>hb(p,w,f))}function hb(b,w,f){if(b.type==="text.delta")return{type:"TEXT_MESSAGE_CONTENT",threadId:w,runId:f,delta:b.delta||""};if(b.type==="thinking.delta")return{type:"THINKING_MESSAGE_CONTENT",threadId:w,runId:f,delta:b.delta||""};if(b.type==="tool.start")return{type:"TOOL_CALL_START",threadId:w,runId:f,toolCallId:b.toolCallId,payload:e1(b)};if(b.type==="tool.delta")return{type:"TOOL_CALL_ARGS",threadId:w,runId:f,toolCallId:b.toolCallId,delta:b.delta||""};if(b.type==="tool.end")return{type:"TOOL_CALL_END",threadId:w,runId:f,toolCallId:b.toolCallId,payload:e1(b)};return{type:b.type.toUpperCase().replaceAll(".","_"),threadId:w,runId:f,payload:b}}function e1(b){return{name:b.toolName||"tool",args:b.args||{},result:b.result||"",isError:b.isError===!0}}var H1="pi-web-chat.sessions.v1";var z0="plugin.pi-web-sidebar.selectedSession",N0="plugin.pi-web-sidebar.event",O0="plugin.pi-web-sidebar.activeSessionId",B1="plugin.pi-web-sidebar.activeWorkspaceId",zb=12,b0=20,m=200,Nb=200,Ob=24,l1=200,jb=8,Vb=1e6,Zb=64000;var Jb=250,Gb=100,yb=6,Cb=100,j0="piWebChatAssistantOnlyAnchorUsed",d=new Set,Y1=new WeakMap,qb={"book-open":'<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',"file-plus":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="M9 15h6"/>',pencil:'<path d="M21.2 6.8 17.2 2.8a2 2 0 0 0-2.8 0L3 14.2V21h6.8L21.2 9.6a2 2 0 0 0 0-2.8z"/><path d="m14 5 5 5"/>',terminal:'<path d="m4 17 6-6-6-6"/><path d="M12 19h8"/>',cpu:'<rect x="6" y="6" width="12" height="12" rx="2"/><path d="M9 1v3"/><path d="M15 1v3"/><path d="M9 20v3"/><path d="M15 20v3"/><path d="M20 9h3"/><path d="M20 15h3"/><path d="M1 9h3"/><path d="M1 15h3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',braces:'<path d="M8 3H7a2 2 0 0 0-2 2v4a2 2 0 0 1-2 2 2 2 0 0 1 2 2v4a2 2 0 0 0 2 2h1"/><path d="M16 21h1a2 2 0 0 0 2-2v-4a2 2 0 0 1 2-2 2 2 0 0 1-2-2V7a2 2 0 0 0-2-2h-1"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',"circle-question-mark":'<circle cx="12" cy="12" r="10"/><path d="M9.1 9a3 3 0 1 1 5.8 1c-.5 1-1.4 1.5-2.1 2-.6.4-.8.8-.8 2"/><path d="M12 17h.01"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',plug:'<path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a6 6 0 0 1-12 0V8Z"/>',"git-branch":'<line x1="6" x2="6" y1="3" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>',"circle-check":'<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>',hammer:'<path d="m15 12-8.5 8.5a2.1 2.1 0 0 1-3-3L12 9"/><path d="m17.6 5.4 1.8-1.8"/><path d="m14 7 3 3"/><path d="M5 11 2 8l6-6 3 3"/>',package:'<path d="m7.5 4.3 9 5.2"/><path d="M21 8a2 2 0 0 0-1-1.7l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.7l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.7Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>'},_1=new WeakMap,Fb={read:"book-open",write:"file-plus",edit:"pencil",ctx_execute:"cpu",ctx_batch_execute:"cpu",ctx_execute_file:"cpu",ctx_search:"cpu",ctx_index:"cpu",ctx_fetch_and_index:"cpu",web_search:"globe",fetch_content:"search",get_search_content:"search",code_search:"braces",document_parse:"file-text",ask_user_question:"circle-question-mark",teams:"users",subagent:"users",mcp:"plug",git:"git-branch"};class V0{#b=[];add(b){if(b)this.#b.push(b);return b}listen(b,w,f){b.addEventListener(w,f),this.add({remove:()=>b.removeEventListener(w,f)})}dispose(){for(let b of this.#b.splice(0).reverse())if(typeof b==="function")b();else if("unsubscribe"in b)b.unsubscribe();else b.remove()}}function Xb(b={}){let w=b.app;if(w?.piWebChat?.dispose(),typeof b.mount?.chat!=="function"||typeof b.mount?.composer!=="function")throw Error("pi-web-chat requires modern pi-web mount.chat and mount.composer APIs");return Qb(b,w)}function Qb(b,w){let f=new V0,p=f.add(s1());Yb(w);let L=d1(),T=n1(),$=b.mount?.chat(L,{replace:!0}),H=b.mount?.composer(T,{replace:!0});if(Yw(f,L),$)f.add($);if(H)f.add(H);let _=g(b);u(b,_||void 0);let R=_?.sessionId?$2(_.sessionId):T2(),h={backendChatToken:0,historyPages:new Map,pendingPromptEchoIds:new Map,pendingAssistantEchoIds:new Map,completedRunIds:new Set};if(!_?.sessionId)N1(L);else X(L,w1(R).messages,R.activeSessionId),z1(b,L,R,h,_.sessionId);Jw(f,b,L,R,h),Dw(f,b,L,R,h),Ab(f,L,R,h),ib(f,b,T,L,R,h),Db(b,T),w?.classList.add(Z1());let z=()=>{if(h.runEventsAbort?.abort(),h.sessionEventsAbort?.abort(),f.dispose(),d.clear(),p.remove(),w?.classList.remove(Z1()),w?.piWebChat===N)delete w.piWebChat},N={dispose:z};if(w)w.piWebChat=N;return z}function Yb(b){if(!b)return;b.querySelectorAll(".pi-web-chat-surface, .pi-web-chat-composer").forEach((w)=>{w.remove()})}function Db(b,w){L1(w,{}),Ub(b,w)}async function Ub(b,w){try{let f=Q(b),p=f.path?{workspacePath:f.path}:{},L=await K(b,"runtimeStatus",p,f.id),T=U(L)?L:{},$=U(T.status)?Kb(T.status):void 0;if(!$)return;L1(w,$)}catch{}}function Kb(b){let w={};if(typeof b.model==="string")w.model=b.model;if(typeof b.modelProvider==="string")w.modelProvider=b.modelProvider;if(typeof b.thinkingLevel==="string")w.thinkingLevel=b.thinkingLevel;if(typeof b.fiveHourQuota==="number")w.fiveHourQuota=b.fiveHourQuota;if(typeof b.weeklyQuota==="number")w.weeklyQuota=b.weeklyQuota;if(typeof b.currentBranch==="string")w.currentBranch=b.currentBranch;if(typeof b.branch==="string")w.branch=b.branch;if(typeof b.warning==="string")w.warning=b.warning;return w}function ib(b,w,f,p,L,T){let $=f.querySelector(".prompt-textarea"),H=f.querySelector(".send-btn"),_=f.querySelector(".attach-btn"),R=f.querySelector(".stop-btn"),h=f.querySelector("[data-file-input]"),z=f.querySelector(".attach-chips"),N=f.querySelector(".shell-attachment-note");if(!$||!H)return;let V=f.querySelector(".prompt-bar"),J=f.querySelector(".slash-pop"),Z=f.querySelector(".prompt-file-ref-pop"),j={selectedAttachments:[],shellMode:!1,commands:[]},Y=()=>{lb(z,$.value,j)},i=()=>{Eb(V,$,_,N,j)},C=()=>{let y=$.value,G=Wb(T),W=Boolean(T.pendingSteering),O=Boolean(T.activeRunId&&T.activeRunSessionId===L.activeSessionId),F=W?"steering":G?"loading":"idle",A=Boolean(y.trim())&&!W&&!T.resolvingSubmit&&(!G||O);if(o1(H,F,A),V)V.dataset.runState=F;if(R){let E=Boolean(T.pendingSteering&&!T.pendingSteering.sent);R.hidden=!G&&!E,R.disabled=!1,R.title=E?"cancel steering":"stop response",R.setAttribute("aria-label",E?"cancel steering":"stop response")}if(Y(),w0(j),j.shellMode){C1(J,Z);return}ub(w,f,$,y,j.commands,(E)=>{j.commands=E}),j.fileSearchTimer=setTimeout(()=>{Ib(w,f,$,$.value)},120)},I=()=>{j.shellMode=!0,C1(J,Z),i(),Y()},f1=()=>{j.shellMode=!1,i(),Y()},M=async(y)=>{y?.preventDefault(),y?.stopImmediatePropagation();let G=$.value.trim();if(C(),T.resolvingSubmit||T.pendingSteering)return;if(T.startingRunSessionId||T.fallbackSubmittingSessionId)return;if(!G){$.value="",C();return}if(T.resolvingSubmit=!0,$.value="",h)h.value="";C();try{if(j.shellMode)L0(G,[]),await Mb(w,p,L,G),f1();else{let W=[...j.selectedAttachments,...await xb(w,G)];j.selectedAttachments=[],Y(),L0(G,W);let O=nb(w,p,L,T,G,W,C);T.resolvingSubmit=!1,C(),await O}}catch(W){if(!o0(W))X(p,[vb(W)],L.activeSessionId)}finally{T.resolvingSubmit=!1,i(),C()}};if(b.listen($,"input",()=>{if(!j.shellMode&&$.value.startsWith("! "))$.value=$.value.slice(2),I();C()}),b.listen($,"keydown",(y)=>{let G=y;if(G.key===" "&&!j.shellMode&&$.value==="!"&&$.selectionStart===1&&$.selectionEnd===1){G.preventDefault(),$.value="",I(),C();return}if(G.key==="Backspace"&&j.shellMode&&$.value===""){G.preventDefault(),f1(),C();return}if(G.key==="Escape"){C1(J,Z);return}if(G.key==="Enter"&&(G.metaKey||G.ctrlKey))M(G)}),b.listen(H,"click",(y)=>{M(y)}),R)b.listen(R,"click",(y)=>{y.preventDefault(),y.stopImmediatePropagation(),Bb(w,p,L,T).finally(C),C()});if(_&&h)b.listen(_,"click",()=>{if(!j.shellMode)h.click()}),b.listen(h,"change",()=>{Pb(h,(y)=>{j.selectedAttachments=y,Y()})});T.onRunStateChange=C,b.add({remove:()=>{if(w0(j),T.onRunStateChange===C)T.onRunStateChange=void 0}}),i(),C()}function Wb(b){return Boolean(b.activeRunId||b.startingRunSessionId||b.fallbackSubmittingSessionId||b.pendingSteering)}function Ab(b,w,f,p){b.listen(w,"click",(L)=>{let $=L.target?.closest?.("[data-action='cancel-steering']");if(!$)return;L.preventDefault(),L.stopPropagation();let H=$.dataset.sessionId||"",_=$.dataset.messageId||"";if(!Z0(f,p)&&H&&_)t(f,H,_);if(H&&f.activeSessionId===H)X(w,D(f,H).messages,H)})}async function Bb(b,w,f,p){if(p.pendingSteering&&!p.pendingSteering.sent){let H=p.pendingSteering.sessionId;if(Z0(f,p),f.activeSessionId===H)X(w,D(f,H).messages,H);return}let L=p.activeRunId,T=p.activeRunSessionId||p.startingRunSessionId||p.fallbackSubmittingSessionId||f.activeSessionId,$=p.activeRunWorkspaceId||Q(b).id;if(!L){p.runEventsAbort?.abort(),p.startingRunSessionId=void 0,p.fallbackSubmittingSessionId=void 0;return}p.runEventsAbort?.abort();try{await Q0(b,L,T,$)}catch(H){globalThis.piWeb?.subject("toast.requested").next({level:"error",message:`stop failed: ${V1(H)}`})}finally{if(p.activeRunId===L)p.activeRunId=void 0,p.activeRunSessionId=void 0,p.activeRunWorkspacePath=void 0,p.activeRunWorkspaceId=void 0}}function Z0(b,w){let f=w.pendingSteering;if(!f||f.sent)return!1;return clearTimeout(f.timeout),f.controller.abort(),w.pendingSteering=void 0,t(b,f.sessionId,f.messageId),!0}function lb(b,w,f){if(!b)return;if(f.shellMode){y1(b,[]);return}y1(b,[...f.selectedAttachments.map((p)=>p.name||"attachment"),...J0(w)])}function Eb(b,w,f,p,L){if(b?.classList.toggle("shell-mode",L.shellMode),w.setAttribute("placeholder",L.shellMode?"run shell command in workspace…":"ask pi to do something…"),p)p.hidden=!(L.shellMode&&L.selectedAttachments.length>0);if(f)G1(f,L.shellMode?"shell":"normal")}function w0(b){if(b.fileSearchTimer)clearTimeout(b.fileSearchTimer),b.fileSearchTimer=void 0}function C1(b,w){b?.setAttribute("hidden",""),w?.setAttribute("hidden","")}function vb(b){return{id:v(),role:"system",text:`prompt failed: ${V1(b)}`,createdAt:Date.now()}}async function Pb(b,w){let f=Array.from(b.files||[]).slice(0,jb),p=[];for(let L of f){if(L.size>Vb)continue;p.push({name:L.name,size:L.size,content:await L.text(),mimeType:L.type||void 0})}w(p)}async function Mb(b,w,f,p){let L=i0(b,f),T=D(f,L),$={id:v(),role:"user",text:`! ${p}`,createdAt:Date.now()},H={id:v(),role:"tool",text:`$ ${p}
(running...)`,createdAt:Date.now()};T.messages.push($,H),T.updatedAt=Date.now(),q(f),X(w,T.messages,L);try{let _=await K(b,"runShell",{command:p}),R=typeof _.exitCode==="number"?_.exitCode:1,h=typeof _.durationMs==="number"?_.durationMs:0,z=typeof _.output==="string"?_.output:"";H.text=kb(p,z,R,h,Boolean(_.truncated))}catch(_){H.text=`$ ${p}
${V1(_)}`}T.updatedAt=Date.now(),q(f),X(w,T.messages,L)}async function xb(b,w){let f=J0(w);if(!f.length)return[];let p=await K(b,"resolveContext",{text:w,refs:f});return Array.isArray(p.attachments)?p.attachments.filter(U):[]}function kb(b,w,f,p,L){let T=gb(w,Zb),$=L||T.truncated,H=T.text.endsWith(`
`)||!T.text?"":`
`;return`$ ${b}
${T.text}${H}[exit ${f} · ${p}ms${$?" · truncated":""}]`}function gb(b,w){let f=new TextEncoder,p=f.encode(b);if(p.byteLength<=w)return{text:b,truncated:!1};let L=new TextDecoder().decode(p.slice(0,w));while(L&&f.encode(L).byteLength>w)L=L.slice(0,-1);return{text:L,truncated:!0}}async function ub(b,w,f,p,L,T){let $=w.querySelector(".slash-pop"),H=w.querySelector(".slash-list"),_=dw(p);if(_===null||!H){$?.setAttribute("hidden","");return}let R=L;if(!R.length){let z=await K(b,"commands",{});R=Array.isArray(z.commands)?z.commands.filter(U):[],T(R)}if(f.value!==p)return;let h=R.filter((z)=>{return $1(z).slice(1).toLowerCase().includes(_)});cb(H,h,f,$),$?.toggleAttribute("hidden",h.length===0)}async function Ib(b,w,f,p){let L=w.querySelector(".prompt-file-ref-pop"),T=w.querySelector(".prompt-file-ref-list"),$=nw(p);if($===null||!T){L?.setAttribute("hidden","");return}try{let H=await K(b,"searchFiles",{query:$,limit:zb}),_=Array.isArray(H.files)?H.files.filter(U):[];if(f.value!==p)return;rb(T,f,_,L),L?.toggleAttribute("hidden",_.length===0)}catch{L?.setAttribute("hidden","")}}function cb(b,w,f,p){b.replaceChildren(...w.map((L)=>{let T=document.createElement("button"),$=$1(L);return T.type="button",T.className="slash-item",T.dataset.slash=$,T.innerHTML='<span class="sl-name"></span><span class="sl-desc"></span>',T.querySelector(".sl-name").textContent=$,T.querySelector(".sl-desc").textContent=L.description||"",T.addEventListener("click",()=>{f.value=L.template||`${$} `,p?.setAttribute("hidden",""),f.dispatchEvent(new(f.ownerDocument.defaultView?.Event||Event)("input",{bubbles:!0})),f.focus()}),T}))}function rb(b,w,f,p){b.replaceChildren(...f.map((L)=>{let T=L.path||L.name||"",$=document.createElement("button");return $.type="button",$.className="prompt-file-ref-item",$.dataset.path=T,$.disabled=!T,$.innerHTML='<span class="pfr-path"></span><span class="pfr-kind"></span>',$.querySelector(".pfr-path").textContent=T,$.querySelector(".pfr-kind").textContent=typeof L.size==="number"?`${L.size} bytes`:"file",$.addEventListener("click",()=>{Sb(w,T),p?.setAttribute("hidden","")}),$}))}function Sb(b,w){if(!w)return;let{value:f,selectionStart:p}=b,L=f.slice(0,p),T=/(?:^|\s)@([^\s@`]*)$/.exec(L),$=T?p-(T[1]||"").length-1:p,H=`@${w} `;b.value=`${f.slice(0,$)}${H}${f.slice(p)}`;let _=$+H.length;b.setSelectionRange(_,_),b.dispatchEvent(new(b.ownerDocument.defaultView?.Event||Event)("input",{bubbles:!0})),b.focus()}function y2(b){return{input$:b.behaviorSubject("chat.input",""),submitted$:b.subject("chat.input.submitted"),activeSessionId$:b.behaviorSubject("session.activeId",null),sidebarSelectedSession$:b.behaviorSubject(z0,mb()),toastRequested$:b.subject("toast.requested")}}function J0(b){let w=[],f=new Set,p=/(^|[\s`])@([^\s@`]+)/g,L=p.exec(String(b||""));while(L!==null){let T=L[2]||"";if((L[1]||"")!=="`"&&T&&!f.has(T))f.add(T),w.push(T);L=p.exec(String(b||""))}return w}function C2(b=[],w=[]){let f=[],p=new Set;for(let L of[...b,...w]){let T=$1(L);if(!T||p.has(T))continue;p.add(T),f.push(L)}return f}function h1(b){return b.app?.piWebSidebar?.getSnapshot?.().activeWorkspaceId||b.app?.dataset.activeWorkspaceId||""}function mb(){return g({})}function g(b){let w=b.app?.piWebSidebar?.getSnapshot?.()||globalThis.piWebSidebar?.getSnapshot?.(),f=w?.activeSessionId||"",p=w?.activeWorkspaceId||"";if(f&&b.app?.dataset.clearedSessionId!==f)return{sessionId:f,workspaceId:p||void 0};return null}function u(b,w){if(w?.workspaceId&&b.app)b.app.dataset.activeWorkspaceId=w.workspaceId,f0(B1,w.workspaceId);if(w?.sessionId)delete b.app?.dataset.clearedSessionId,b.app?.setAttribute("data-active-session-id",w.sessionId),f0(O0,w.sessionId)}function G0(b){let w=g(b);if(w?.sessionId&&b.app)b.app.dataset.clearedSessionId=w.sessionId;b.app?.removeAttribute("data-active-session-id"),db(O0),globalThis.piWeb?.behaviorSubject("session.activeId",null).next(null)}function o(b,w,f={}){let p=b.app?.piWebSidebar?.getSnapshot?.()||globalThis.piWebSidebar?.getSnapshot?.(),L={type:w,detail:f,snapshot:p};(b.app?.piWebSidebar?.channels?.events$||globalThis.piWebSidebar?.channels?.events$)?.next(L),globalThis.piWeb?.subject(N0).next(L)}function E1(b,w,f){let p=b.app?.dataset.activeWorkspaceId||h1(b),L={reason:f,sessionId:w,workspaceId:p};globalThis.piWeb?.behaviorSubject("session.activeId",w).next(w),o(b,"active.start",L),o(b,"session.created",L)}function v1(b,w){globalThis.piWeb?.subject("session.changed").next({sessionId:b,name:w,title:w})}function P1(b){if(b.title!=="New chat")return"";let f=b.messages.find((p)=>p.role==="user")?.text.slice(0,48)||"";if(!f)return"";return b.title=f,f}function f0(b,w){try{localStorage.setItem(b,w)}catch{}}function db(b){try{localStorage.removeItem(b)}catch{}}async function K(b,w,f={},p=h1(b)){if(!b.backend)return{};let L=await b.backend(w,{workspaceId:p,data:f});return U(L)?L:{}}function D1(b){let w=Array.isArray(b.warnings)?b.warnings.filter((f)=>typeof f==="string"&&f.trim().length>0):[];for(let f of w)globalThis.piWeb?.subject("toast.requested").next({level:"warning",message:f})}function q2(b,w){return b.trim().startsWith("!")?[]:[...w]}async function nb(b,w,f,p,L,T,$=()=>{}){let H=i0(b,f),_=Q(b);if(p.activeRunId&&p.activeRunSessionId===H){let j=p.activeRunWorkspacePath||_.path,Y=p.activeRunWorkspaceId||_.id;await ab(b,w,f,p,L,T,j,Y,$);return}if(p.startingRunSessionId===H||p.fallbackSubmittingSessionId===H)return;p.backendChatToken+=1,p.startingRunSessionId=H,$(),p.runEventsAbort?.abort();let R=new AbortController;p.runEventsAbort=R,p.sessionEventsAbort?.abort();let h={id:v(),role:"user",text:L,attachments:r1(T),createdAt:Date.now()},z=D(f,H);A1(p.pendingPromptEchoIds,H,h.id),z.messages.push(h),z.updatedAt=Date.now(),q(f),X(w,z.messages,H);let N;try{N=await pw(b,L,T,H,_.path,_.id)}catch(j){throw p.startingRunSessionId=void 0,$(),j}if(R.signal.aborted){if(p.startingRunSessionId=void 0,typeof N.runId==="string"&&N.runId)await Q0(b,N.runId,H,_.id);t(f,H,h.id),$();return}if(D1(N),typeof N.activeSessionId==="string"&&N.activeSessionId){let j=H,Y=f.activeSessionId===j;if(H=N.activeSessionId,Y)n(f,H),u(b,{sessionId:N.activeSessionId,workspaceId:_.id||void 0}),o(b,"chat-session",{reason:"startPrompt",sessionId:N.activeSessionId}),E1(b,N.activeSessionId,"startPrompt");else D(f,H);r0(f,j,H,h.id),p2(p.pendingPromptEchoIds,j,H)}if(typeof N.runId!=="string"||!N.runId){p.startingRunSessionId=void 0,p.fallbackSubmittingSessionId=H,$();let j;try{j=await Lw(b,L,T,H,_.path,_.id)}catch(I){throw p.fallbackSubmittingSessionId=void 0,$(),I}if(R.signal.aborted){p.fallbackSubmittingSessionId=void 0,t(f,H,h.id),$();return}D1(j);let Y=typeof j.activeSessionId==="string"&&j.activeSessionId?j.activeSessionId:H,i=e(p.pendingPromptEchoIds,H),C=Zw(b,f,j,"submitPrompt",H,i);if(b1(p.pendingPromptEchoIds,Y,C,i),f.activeSessionId===H||f.activeSessionId===Y)X(w,C,f.activeSessionId);if(p.runEventsAbort===R)p.runEventsAbort=void 0;p.startingRunSessionId=void 0,p.fallbackSubmittingSessionId=void 0,$();return}let V=D(f,H);p.activeRunId=N.runId,p.activeRunSessionId=H,p.activeRunWorkspacePath=_.path,p.activeRunWorkspaceId=_.id,p.startingRunSessionId=void 0,$();let J=P1(V);if(J)q(f),v1(H,J);let Z=$w(V);A1(p.pendingAssistantEchoIds,H,Z.id);try{await sb(b,f,V,N.runId,_.path,_.id,Z,()=>{if(!R.signal.aborted&&f.activeSessionId===H)X(w,V.messages,H)},R.signal)}finally{if(Nw(p,N.runId),p.activeRunId===N.runId)p.activeRunId=void 0,p.activeRunSessionId=void 0,p.activeRunWorkspacePath=void 0,p.activeRunWorkspaceId=void 0,p.startingRunSessionId=void 0,p.fallbackSubmittingSessionId=void 0,$();if(p.runEventsAbort===R)p.runEventsAbort=void 0}if(!R.signal.aborted&&f.activeSessionId===H)z1(b,w,f,p,H,_.path,_.id)}async function ab(b,w,f,p,L,T,$,H,_=()=>{}){let{activeRunId:R,activeRunSessionId:h}=p;if(!R||!h)throw Error("active run is unavailable for steering");if(p.pendingSteering)return;let z={id:v(),role:"user",text:L,attachments:r1(T),createdAt:Date.now(),meta:{piWebChatSteeringState:"pending"}},N=D(f,h),V=new AbortController,J=ob(V.signal,()=>{let Z=p.pendingSteering;if(Z){if(Z.sent=!0,tb(f,Z.sessionId,Z.messageId),f.activeSessionId===Z.sessionId)X(w,D(f,Z.sessionId).messages,Z.sessionId);_()}});if(p.pendingSteering={sessionId:h,messageId:z.id,timeout:J.timeout,controller:V,sent:!1},A1(p.pendingPromptEchoIds,h,z.id),N.messages.push(z),N.updatedAt=Date.now(),q(f),f.activeSessionId===h)X(w,N.messages,h);_();try{if(await J.promise,V.signal.aborted)return;let Z=await Tw(b,R,L,T,h,$,H);D1(Z)}catch(Z){if(o0(Z))return;if(t(f,h,z.id),f2(p.pendingPromptEchoIds,h,z.id),X0(Z)){X(w,N.messages,h),globalThis.piWeb?.subject("toast.requested").next({level:"error",message:"This backend does not support steering while a response is streaming."});return}throw Z}finally{if(p.pendingSteering?.controller===V)p.pendingSteering=void 0,_()}}function ob(b,w){let f,p=new Promise((L,T)=>{f=setTimeout(()=>{w(),L()},Cb),b.addEventListener("abort",()=>{clearTimeout(f),T(new DOMException("Steering cancelled","AbortError"))},{once:!0})});return{timeout:f,promise:p}}function t(b,w,f){let p=b.sessions.find((L)=>L.id===w);if(!p)return;p.messages=p.messages.filter((L)=>L.id!==f),S0(b,p.id),q(b)}function tb(b,w,f){let p=D(b,w).messages.find((L)=>L.id===f);if(!p?.meta)return;if(delete p.meta.piWebChatSteeringState,Object.keys(p.meta).length===0)delete p.meta;q(b)}async function sb(b,w,f,p,L,T,$,H,_){let R=await C0(b,"streamEventsSse",{runId:p,cursor:0,workspacePath:L},_,T);if(!R)throw Error("SSE streaming backend did not return a stream");let h=y0(H),z=eb(w,Gb);$.streaming=!0,h.flush();try{await q0(R,(N)=>{Hw($,[N]),$.streaming=N.type!=="run.end",f.updatedAt=Date.now(),z.request(),h.request()})}finally{$.streaming=!1,z.flush(),h.flush()}}function eb(b,w){let f=0,p,L=()=>{if(p)clearTimeout(p),p=void 0},T=()=>{L(),f=Date.now(),q(b)};return{request:()=>{let H=w-(Date.now()-f);if(H<=0){T();return}p||=setTimeout(T,H)},flush:T}}function y0(b){let w=0,f,p=()=>{if(f)clearTimeout(f),f=void 0},L=()=>{p(),w=Date.now(),b()};return{request:()=>{let $=Jb-(Date.now()-w);if($<=0){L();return}f||=setTimeout(L,$)},flush:L,cancel:p}}async function C0(b,w,f={},p,L=h1(b)){if(!b.backendStream)throw Error("SSE streaming backend is unavailable");let T=await b.backendStream(w,{workspaceId:L,data:f},{signal:p});return bw(T)}function bw(b){if(typeof ReadableStream<"u"&&b instanceof ReadableStream)return b;if(typeof Response<"u"&&b instanceof Response)return b.body;if(typeof b==="string")return p0(b);if(!U(b))return null;let w=b.body;if(typeof ReadableStream<"u"&&w instanceof ReadableStream)return w;let f=b.sse;if(typeof f==="string")return p0(f);return null}function p0(b){let w=new TextEncoder().encode(b);return new ReadableStream({start(f){f.enqueue(w),f.close()}})}async function q0(b,w){let f=b.getReader(),p=new TextDecoder,L="";while(!0){let T=await f.read();if(T.done){L+=p.decode(),fw(L,w);return}L+=p.decode(T.value,{stream:!0});let $=ww(L);L=$.remainder;for(let H of $.frames)F0(H,w)}}function ww(b){let f=b.replaceAll(`\r
`,`
`).replaceAll("\r",`
`).split(`
